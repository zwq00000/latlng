  ...
  methods: {
    initProps() {
      if (this.decimal) {
        ...
        this.value = lat + " " + lng;
        this.mask = "wwww11111 wwwww11111";
        ...
        this.value = decimalLatToDegree(this.lat) + " " + decimalLngToDegree(this.lng);
        this.mask = "11ยบ 11.111' N 111ยบ 11.111' W";
        this.formatCharacters = {
          W: {
            validate(char) {
    ...
    onMaskChanged(e) {
      ...
      if (this.props.decimal) {
        let lat = value.substr(0, 9);
        let lng = value.substr(10, 20);
        ...
        let lat = degreeLatToDecimal(value.substr(0, 13));
        let lng = degreeLngToDecimal(value.substr(14, 29));
